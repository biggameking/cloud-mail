const en = {
	...
	aiInvalidMonitorName: 'Invalid monitoring rule name',
	aiSelectMailbox: 'Select at least one valid mailbox',
	aiInvalidMonitor: 'Invalid monitoring rule',
	aiMonitorNotFound: 'Monitoring rule not found',
	aiMailboxUnavailable: 'One or more mailboxes are unavailable',
	aiInvalidFilter: 'Invalid monitoring filter',
	aiInvalidSchedule: 'Invalid digest time; minutes must be 00 or 30',
	aiInvalidTimezone: 'Invalid digest timezone',
	aiInvalidLanguage: 'Invalid digest language',
	aiInvalidDigest: 'Invalid digest',
	aiDigestNotFound: 'Digest not found',
	aiInvalidDigestSource: 'Invalid digest source',
	aiDigestSourceNotFound: 'Digest source email not found',
	aiMonitoringDisabled: 'AI mail monitoring is disabled',
	aiNoEligibleEmails: 'No eligible emails are available for preview',
	aiBudgetExceeded: 'The daily AI budget has been reached',
	aiPreviewUnavailable: 'A preview cannot be generated right now. Try again later.',
	aiEnvironmentDisabled: 'The deployment-level AI switch is still disabled',
	aiDigestEmailDisclaimer: 'This summary was generated by AI. Verify important details against the source email in the Cloud Mail console.',
	aiDigestOpenSource: 'Sign in to Cloud Mail to view the source email',
	aiDeliveryDisabled: 'Digest delivery is disabled',
	aiDeliveryUnavailable: 'Digest delivery is not configured',
	aiDeliveryAttemptsExceeded: 'This digest has reached the maximum delivery attempts',
	...
	aggregateInboxDisabled: 'The super-admin aggregate inbox is disabled',
	invalidMailboxUser: 'The mailbox user does not exist or is unavailable',
	invalidMailboxAccount: 'The mailbox does not exist or is unavailable',
